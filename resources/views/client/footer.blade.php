       ...
       <div class="col-lg-3 col-md-6">
         <div class="single-footer-widget">
           ...
           <ul class="import-link">
             ...
             <li>
               <a href="recrutements.php">Récrutements</a>
             </li>
         ...
         <div class="single-footer-widget">
           ...
           <ul class="address">
             <li class="location">
               ...
               Imm Sprols Fourat 1 Nouvelle Medina
               1200 KASSERINE KASSERINE
             </li>
             <li>
               <i class="bx bxs-envelope"></i>
               <span>contact@srtk.com</span>
             </li>
             <li>
 ...
 <div class="copy-right-area">
   <div class="container">
     <p>
       Copyright <i class="bx bx-copyright"></i>2023 SRTK. Designed By
       <a href="#" target="_blank">ICS</a>
     </p>
   </div>
 </div>
