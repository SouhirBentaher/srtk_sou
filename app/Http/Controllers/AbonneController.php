...
class AbonneController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $abonne->num_telephone = $request->num_telephone;
        $abonne->classe = $request->classe;
        $abonne->photo = $request->photo;
        $abonne->email = $request->email;
        $abonne->cin = $request->cin;
        $abonne->date_emission = $request->date_emission;
        $abonne->nom_parent = $request->nom_parent;
        $abonne->prenom_parent = $request->prenom_parent;
        $abonne->cin_parent = $request->cin_parent;
        $abonne->etablissement_id = $request->etablissement_id;
        $abonne->type_abonnes_id = $request->type_abonnes_id;
        $abonne->save();

        return response()->json([
            'message' => 'Abonné ajouté avec succée',
            'data' => $abonne
        ]);
    }
